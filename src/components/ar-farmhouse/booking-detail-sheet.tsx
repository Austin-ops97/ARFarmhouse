...
export function BookingDetailSheet({ bookingId, open, onOpenChange }: BookingDetailSheetProps) {
  ...
  const runAction = async (label: string, fn: () => Promise<void>, success: string) => {
  ...
  const canRemove = booking && profile && canDeleteBooking(profile, booking);
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overscroll-contain px-5 py-4">
              ...
              {booking && (
                <motion.div layout={!reduceMotion} className="space-y-5">
                  ...
                  <div className="grid gap-3 rounded-2xl border border-border/50 bg-muted/20 p-4 dark:border-white/[0.08] dark:bg-white/[0.03]">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                      ...
                      <>
                        ...
                        <Button
                          ...
                          onClick={() =>
                            void runAction(
                              "deny",
                              () => denyBooking(booking.id, actor!, "Declined"),
                              "Denied."
                            )
                          }
                        >
                    ...
                    {canCancel && (
                      <Button
                        ...
                        disabled={acting || !actor}
                        onClick={() =>
                          void runAction("cancel", () => cancelBooking(booking.id, actor!), "Cancelled.")
                        }
                      >
                        Cancel booking
                      </Button>
